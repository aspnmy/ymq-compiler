...
apply_dense_preset() {
    case "$1" in
        ...
        xxs-pro)PRESET_NAME="XXS-Pro"; INPUT_TARGET="Q2_K"; COPY_TARGET="IQ3_S"; TINY_TARGET="IQ3_S"; HIGH_TARGET="IQ3_XXS"; MID_TARGET="IQ3_XXS"; LOW_TARGET="IQ2_S";  DEFAULT_TARGET="IQ2_S"; FLOOR_TARGET="IQ2_XXS"; FLOOR_SCALE="1.5" ;;
